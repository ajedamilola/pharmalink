      ...
      <div className='w-full max-w-md space-y-6'>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Join the PharmaLink supply chain network
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleRegister} className='space-y-4'>
              <div className='space-y-2'>
                ...
                <Select
                  value={form.role}
                  onValueChange={(v: "pharmacy" | "vendor") =>
                    setForm({ ...form, role: v })
                  }
                >
                  <SelectTrigger>
              ...
              {form.role === "vendor" && (
                <p className='text-xs text-muted-foreground bg-muted p-2 rounded'>
                  Vendor accounts require verification before products can be
                  listed. You'll be notified once verified.
                </p>
              )}
