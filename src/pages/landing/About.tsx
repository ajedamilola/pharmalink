...
export default function About() {
  return (
    <section
      id='about'
      className='bg-white text-green-950 py-20 px-4 md:px-12 font-[arimo]'
    >
        ...
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 items-start'>
          ...
          <div className='col-span-1 lg:col-span-8 flex flex-col gap-8'>
            ...
            <p className='text-green-950/70 text-lg md:text-xl max-w-2xl leading-relaxed'>
              Welcome to the future of inventory management. We are pushing the
              boundaries of supply chain architecture. Our team is committed to
              providing intuitive, AI-driven solutions that empower pharmacists
