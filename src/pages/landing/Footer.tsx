...
export default function Footer() {
  return (
    <footer className="bg-white text-green-950 font-[arimo]">
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 pt-20 pb-10 border-t border-green-950/10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-24">
            ...
            <div className="text-left md:text-right">
                <h4 className="text-xl md:text-2xl font-medium mb-4 text-green-950">Office</h4>
                <div className="text-green-950/60 leading-relaxed text-sm md:text-base">
