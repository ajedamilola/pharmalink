      ...
      <div className='grid grid-cols-1 lg:grid-cols-12 gap-8 w-full max-w-[1400px] mx-auto mt-4'>
        ...
        <div className='col-span-1 lg:col-span-4 flex flex-col justify-end gap-12 relative'>
          ...
          <div className='flex flex-col gap-8'>
            ...
            {/* Left Bottom Image */}
            <div className='w-full h-48 rounded-[2rem] overflow-hidden relative border border-gray-300'>
              <img
                src='/homeImage1.png'
                alt='User'
        ...
        <div className='col-span-1 lg:col-span-8 relative'>
          <div className='w-full h-[500px] md:h-[600px] rounded-[3rem] overflow-hidden relative group border border-gray-300 bg-gray-200'>
            <img
              src='/homeImage2.png'
              alt='Collaboration'
            ...
            <div className='absolute top-8 right-8'>
              <div className='flex flex-col gap-4 bg-green-950/5 border border-green-950/10 rounded-3xl p-6 backdrop-blur-sm'>
                <div className='flex items-center gap-4'>
                  ...
                  <span className='text-sm font-bold tracking-widest text-[#22c55e] uppercase'>
                    System Active
                  </span>
                </div>
              </div>
            ...
            {/* Red Alert Pill */}
            {/* <div className='absolute bottom-6 hidden left-6 md:bottom-10 md:left-10 z-20'>
