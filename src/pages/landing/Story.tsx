...
export default function Story() {
  return (
    <section id="story" className="bg-white text-green-950 py-24 px-4 md:px-12 font-[arimo]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="col-span-1 lg:col-span-7 space-y-12">
            <div className="space-y-6">
                <h3 className="text-3xl font-medium text-green-950 flex items-center gap-4">
                    <span className="w-10 h-px bg-[#22c55e]"></span>
                    The Inception
                </h3>
                <p className="text-xl text-green-950/70 leading-relaxed font-light">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 ring-1 ring-green-950/10 p-8 rounded-[2.5rem] bg-green-950/5 backdrop-blur-sm">
                <div className="space-y-4">
                    ...
                    <h4 className="text-xl font-bold text-green-950">The Problem</h4>
                ...
                <div className="space-y-4">
                    ...
                    <h4 className="text-xl font-bold text-green-950">The Solution</h4>
                    <p className="text-sm text-green-950/60">
            ...
            <div className="space-y-8">
               <h3 className="text-3xl font-medium text-green-950">Technological Infrastructure</h3>
               <div className="space-y-6">
                   <div className="flex gap-6 group">
                       <span className="text-[#22c55e] font-mono text-xl">01</span>
                       <div>
                           <h5 className="text-xl font-bold mb-1 group-hover:text-[#22c55e] transition-colors text-green-950">Real-time Sync Engine</h5>
                           <p className="text-green-950/50">Utilizing real-time database technology to achieve sub-500ms synchronization across all branches.</p>
                       </div>
                   </div>
                   <div className="flex gap-6 group">
                       <span className="text-[#22c55e] font-mono text-xl">02</span>
                       <div>
                           <h5 className="text-xl font-bold mb-1 group-hover:text-[#22c55e] transition-colors text-green-950">Multi-Vendor Architecture</h5>
                           <p className="text-green-950/50">Native support for various verification levels ensures no pharmacy is left behind due to regulatory barriers.</p>
                       </div>
                   </div>
               </div>
            </div>
          ...
          <div className="col-span-1 lg:col-span-5 flex flex-col gap-12">
            <div className="relative aspect-3/4 rounded-[3.5rem] overflow-hidden border border-green-950/10 group">
                <img 
                ...
                <div className="absolute bottom-10 left-10 right-10">
                    <div className="bg-white/90 backdrop-blur-2xl border border-green-950/20 p-8 rounded-3xl">
                        <Quote className="text-[#22c55e] mb-6" size={40} />
                        <p className="text-2xl font-medium leading-tight text-green-950">
                        ...
                        <div className="mt-8 flex items-center gap-4">
                            ...
                            <span className="text-xs font-bold uppercase tracking-widest text-green-950/60">Legacy Of Care</span>
                        </div>
                    </div>
                </div>
            </div>
